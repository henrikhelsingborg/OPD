            ...
            "dom": '\
                <\
                    <"table-header table-filter"\
                        <"large-6 column table-filter-info no-margin"i>\
                        <"large-6 column table-filter-search no-margin">\
                        <"clearfix">\
                    >\
                    t\
                    <"clearfix">\
                    <"table-footer"\
                        <"table-filter-length large-6 column no-margin"l>\
                        <"table-filter-paging large-6 column no-margin"p>\
                        <"clearfix">\
                    >\
                >',
            "bStateSave": true,
