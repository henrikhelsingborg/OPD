        ...
        <table id="department_permissions_table" class="display">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="radio" name="department_permission[{$dept.id}]" value="1" {if $dept.rights eq 1 or not $dept.rights}checked="checked"{/if}  /></td>
        ...
        <table id="user_permissions_table" class="display">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="radio" name="user_permission[{$user.id}]" value="1" {if $user.rights eq 1}checked="checked"{/if} /></td>
                    <td><input type="radio" name="user_permission[{$user.id}]" value="2" {if $user.rights eq 2 or not $user.rights}checked="checked"{/if} /></td>
                    <td><input type="radio" name="user_permission[{$user.id}]" value="3" {if $user.rights eq 3}checked="checked"{/if} /></td>
                    <td><input type="radio" name="user_permission[{$user.id}]" value="4" {if $user.rights eq 4 or ($user.id eq $user_id and $user.rights eq '') }checked="checked"{/if} /></td>
                </tr>
                {/foreach}
            </tbody>
        </table>
